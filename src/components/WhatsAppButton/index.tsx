...
export default function WhatsAppButton() {
  return (
    <div>
      <a
        href="https://api.whatsapp.com/send?phone=5527997813275&amp;text=Tem um projeto em mente? Fale comigo! Estou pronto para transformar sua ideia em uma solução eficiente e escalável."
