  ...
  return (
   <div className={` w-full flex justify-between items-center flex-row-reverse ${scrollMenu ? 'bg-white':' md:bg-transparent'}`}>
      ...
      <div className="flex xl:hidden">
        <Link href="/">
        {scrollMenu ? 
         <h1 className="mx-2 lg:mx-0 font-bold   hover:tracking-widest duration-300 text-[24px] md:text-[40px]"><span className="text-blue-500 pl-1 md:pl-0">ELCIO </span>DEV</h1> :
         <h1 className="mx-2 lg:mx-0 font-bold hover:tracking-widest duration-300  text-[#fff] text-[24px] md:text-[40px]"><span>ELCIO </span>DEV</h1>
         }
        </Link>
      </div>
    </div>
